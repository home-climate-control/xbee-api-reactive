...
public class RxResponseIoSample extends RxBaseResponse implements NoRequestResponse {
    ...
    private static final Logger log = LogManager.getLogger(RxResponseIoSample.class);

    public static final int ADC_CHANNEL1 = 0x7e; //01111110
    public static final int DIO_CHANNEL1 = 0x1; //00000001
	...
	private IoSample parseIoSample(IIntInputStream parser) throws IOException {
		...
		if (this.containsAnalog()) {
			...
			log.debug("There are {} analog inputs turned on", analog);
		}
