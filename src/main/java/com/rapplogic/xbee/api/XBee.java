...
public class XBee implements IXBee {
    ...
    private final static Logger log = LogManager.getLogger(XBee.class);
    ...
    private void doStartupChecks() throws XBeeException {
        ...
        try {
            AtCommandResponse ap = sendAtCommand(new AtCommand("AP"));
            ...
            AtCommandResponse vr = sendAtCommand(new AtCommand("VR"));
